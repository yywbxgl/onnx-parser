...
inline std::string* AttributeProto::release_ref_attr_name() {
  ...
  return ref_attr_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline std::string* ModelProto::release_producer_name() {
  ...
  return producer_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline std::string* ModelProto::release_producer_version() {
  ...
  return producer_version_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline std::string* TensorShapeProto_Dimension::release_denotation() {
  ...
  return denotation_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
